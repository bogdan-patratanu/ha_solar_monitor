"""Solarman logger driver implementation (placeholder)."""
import logging
...
class SolarmanDriver(ModbusDriver):
    def __init__(self):
        self.type = 'solarman'
        self.client = None
    ...
    async def connect(self, host: str, port: int, timeout: int) -> bool:
        logger.warning("Solarman driver not yet implemented, falling back to pymodbus")
